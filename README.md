...
For chinese , you can visit this [中文](https://github.com/Yutiy/react-blog/blob/main/README.zh-CN.md)
...
// project config
export const HEADER_BLOG_NAME = 'Yutiy' // header title

// === sidebar
export const SIDEBAR = {
    avatar: require('@/assets/images/avatar.jpeg'), // sidebar image
    title: 'Yutiy', // title
    subTitle: '学而知不足', // subtitle
    // personal website
    homepages: {
    github: {
...
const config = {
  ...
  ADMIN_GITHUB_LOGIN_NAME: 'Yutiy', // your github name
  GITHUB: {
    client_id: '9e10d40a24fcf2848205',
    client_secret: 'a743eb5a6902d0a0985cccf1226a636aac0e1ea3',
  ...
  EMAIL_NOTICE: {
    ...
    transporterConfig: {
      ...
      auth: {
        user: '494657028@qq.com', // generated ethereal user
        pass: 'f2bbfe7cf1bcb8253a65c06701fbbbbf8c910be44ecc1a430497d4879db0d71d' // generated ethereal password
      }
    },
    subject: 'Yutiy的博客 - 您的评论获得新的回复！', // subject for the notification mail
...
Feel free to dive in! [open an issue](https://github.com/Yutiy/react-blog/issues/new) or submit PRs.
